...
class GaussianReplayDataset(Dataset):
    ...
    def set_att(self, att_name, att_data):
    ...
    def __getitem__(self, index: int):
        ret_tuple = (index, self.features[index], self.labels[index])
...
class iCIFAR224(iData):
    ...
    def download_data(self):
        train_dataset = datasets.cifar.CIFAR100(f'{self.dataset_dir}/CIFAR100/', train=True, download=True)
        test_dataset = datasets.cifar.CIFAR100(f'{self.dataset_dir}/CIFAR100/', train=False, download=True)
        self.train_data, self.train_targets = train_dataset.data, np.array(train_dataset.targets)
        self.test_data, self.test_targets = test_dataset.data, np.array(test_dataset.targets)
